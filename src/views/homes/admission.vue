...
const state = reactive({
  treeClass: "trees treesInitAnimate",
  catClass: "catInitAnimate",
});

const aspectRatio = (window.screen.width - 10) / (window.screen.height - 10);
const svgHeight = 1230 / aspectRatio;

const init = () => {
  svgRef.value.setAttribute("viewBox", `130 0 1230 ${svgHeight}`);

  const shopTranslateY = (svgHeight + 410) * (1 - aspectRatio);

  svgRef.value.style.setProperty(
    "--svg-shop-translateY",
    shopTranslateY + "px"
  );
  svgRef.value.style.setProperty(
    "--svg-parachute-translateY",
    shopTranslateY + 550 + "px"
  );
  console.log(aspectRatio, svgHeight);
};

const treewebkitAnimationEnd = (e: any) => {
  state.treeClass = "treesend ";
  state.catClass = "catEnd";
};
...
<template>
  <div class="store-container">
    <div class="border-animation">
      ...
      >
        ...
        <defs>
          ...
          <g id="tree">
            ...
            <g opacity="0.4">
              ...
              />
              <path fill="#FFB6C1" d="M1153.9 561c4-2.4 7.7-5.4 11-8.7" />
              <path fill="#FFB6C1" d="M1104.3 545.5c-6.7 1.6-13.1 3.9-19.1 7" />
            </g>
            <path
              fill="none"
          ...
          <g id="cat">
            <circle fill="#FFB6C1" cx="1115" cy="625" r="25"></circle>
            <path
              fill="#FFF"
              stroke="#FFB6C1"
              stroke-width="3"
          ...
          <g id="cap">
            ...
            />
            <ellipse fill="#FFB6C1" cx="445.9" cy="763.4" rx="8.5" ry="3" />
            <path
              fill="none"
              class="stroke"
            ...
            <line
              ...
              y2="816.4"
            />
            <circle fill="#FFB6C1" cx="429.4" cy="777.4" r="2" />
            <circle fill="#FFB6C1" cx="462.4" cy="777.4" r="2" />
          </g>
          <g id="ball">
          ...
          <g id="plane">
            ...
            />
            <text
              transform="matrix(1.0027 0 0 1 44.8218 232.8768)"
        ...
        <use
          ...
          y="-725"
        ></use>
        <use class="cloud" xlink:href="#cloud2" x="0" y="20"></use>
        <use class="plane" xlink:href="#plane" y="-80"></use>

        <use class="cloud2" xlink:href="#cloud" x="0" y="230"></use>
        <use class="cloud3" xlink:href="#cloudBg" x="0" y="300"></use>
        <use
          class="cloud3"
          xlink:href="#cloud3bg"
          x="0"
        ...
        <use
          ...
          fill="#B2C7E8"
        ></use>
        <use class="cloud5" xlink:href="#cloud" x="0" y="500"></use>
        <use class="cloud6" xlink:href="#cloud2" x="0" y="600"></use>
        ...
        <use
          ...
          x="40"
          y="0"
          @webkitAnimationEnd="treewebkitAnimationEnd"
          :class="state.treeClass"
        ></use>
        <circle
          class="cat-shadow"
          fill="#FFB6C1"
        ...
        <g id="door">
          ...
          />
          <rect fill="#FFB6C1" x="730" y="700" width="225" height="15"></rect>
          <g id="sign">
            <polyline
              fill="none"
              class="stroke"
        ...
        <rect
          ...
          height="200"
        ></rect>
        <use class="grass" xlink:href="#grass" x="-1230" y="0"></use>
        <use class="grass" xlink:href="#grass" x="0" y="0"></use>
        <use class="grass" xlink:href="#grass" x="1230" y="0"></use>
      </svg>
    </div>
    <div class="chong_main">
    ...
    <div class="chong_main chong_main2">
      <div class="shadow-wrapper">
        <div class="shadow"></div>
      </div>
      <div class="dragon">
...
.chong_main2 {
  ...
  $chong-animation-delay:.6s;
  .dragon {
    animation-delay: $chong-animation-delay;
    .blush,
    .mouth,
    .horn-left,
    .horn-right,
...
.border-animation:after {
  content: "";
  background: linear-gradient(45deg, #fde6e9 48.9%, #ffb6c1 49%);
  ...
  width: calc(100% + $border-w * 2);
  z-index: -1;
  animation: borderGradient 12s linear both infinite;
}
...
@keyframes moveDown {
  ...
  to {
    transform: translate(0, var(--svg-shop-translateY));
  }
}
#toldo {
...
#sign {
  ...
  animation: pendulum 3.5s 2s ease-in-out infinite alternate;
}
.trees {
  transform: translate(0, var(--svg-shop-translateY));
}
...
@keyframes sway {
  0% {
    transform: translate(0, var(--svg-shop-translateY)) rotateZ(0deg);
  }
  25% {
    transform: translate(0, var(--svg-shop-translateY)) rotateZ(3deg);
  }
  50% {
    transform: translate(0, var(--svg-shop-translateY)) rotateZ(0deg);
  }
...
.catEnd {
  animation: catHi 4s linear infinite alternate;
}
.cat-shadow {
  animation: catShadow 4s 2s linear infinite;
}
@keyframes catHi {
  0% {
    opacity: 1;
  ...
  25% {
    opacity: 1;
    transform: translate(20px, calc(var(--svg-shop-translateY) + 0px));
  }
  50% {
    opacity: 1;
    transform: translate(0, var(--svg-shop-translateY));
...
@keyframes catShadow {
  ...
  100% {
    opacity: 1;
    transform: translate(40px, calc(var(--svg-shop-translateY) - 35px))
      scale(0.3);
  }
  10%,
  60% {
    opacity: 1;
    transform: translate(-5px, calc(var(--svg-shop-translateY) + 10px))
      scale(0.5);
  }
  60% {
    opacity: 1;
...
.parachute {
  ...
  animation: moveBox 11s 2s linear forwards infinite;
}
.parachute {
  animation: parachute 11s 2s linear forwards infinite;
}
@keyframes moveBox {
  0% {
    opacity: 0;
  ...
  30% {
    transform: translate(0, calc(var(--svg-parachute-translateY) - 600px))
      rotate(-5deg);
  }
  35% {
    opacity: 1;
    transform: translate(0, var(--svg-parachute-translateY)) rotate(0deg);
  }
  45%,
  100% {
    opacity: 0;
    transform: translate(0, var(--svg-parachute-translateY));
  }
}
@keyframes parachute {
  0% {
  ...
  33% {
    transform: translate(0, calc(var(--svg-parachute-translateY) - 450px))
...
.tshirt {
  animation: fadeInOut 23s 7s ease-in forwards infinite;
}
.cap {
  animation: fadeInOut 23s 12s ease-in forwards infinite;
}
.ball {
  animation: fadeInOut 23s 17s ease-in forwards infinite;
}
#text,
#button {
...
.cloud {
  animation: yunclouds 7s linear backwards infinite;
}
.cloud2 {
  animation: yunclouds 9s 5s linear backwards infinite;
}
.cloud3 {
  animation: yunclouds 6s 4s linear backwards infinite;
}
.cloud4 {
  animation: yunclouds 10s 1s linear backwards infinite;
}
.cloud40 {
  animation: yunclouds 7s 5s linear backwards infinite;
}
.cloud5 {
  animation: yunclouds 9s 2s linear backwards infinite;
}
.cloud6 {
  animation: yunclouds 6s 3s linear backwards infinite;
}
@keyframes yunclouds {
  from {
...
//小飞机
.plane {
  animation: clouds 12s linear forwards;
...
.sky-circle2 {
  animation: fadeInOut 8s 3s ease-in infinite;
  transform: translate(0, 900px);
}
.sky-circle3 {
  animation: fadeInOut 6s 6s ease-in infinite;
  transform: translate(0, var(--svg-parachute-translateY));
}

.sky-circle4 {
  animation: fadeInOut 6s 4s ease-in infinite;
  transform: translate(0, var(--svg-parachute-translateY));
}
.sky-circle5 {
  animation: fadeInOut 6s 3s ease-in infinite;
  transform: translate(0, var(--svg-parachute-translateY));
}
.sky-circle6 {
  animation: fadeInOut 6s 2s ease-in infinite;
  transform: translate(0, var(--svg-parachute-translateY));
}
</style>
